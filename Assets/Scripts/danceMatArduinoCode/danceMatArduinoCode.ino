...
void getStates() 
{
  ...
  section1State = analogRead(section1)*voltageScaler/1024.00;
  if (section1State >= pressThreshold)
    section1State = 1;
  else
    section1State = 0;
    
  section2State = analogRead(section2)*voltageScaler/1024.00;
  if (section2State >= pressThreshold)
    section2State = 1;
  else
    section2State = 0;
    
  section3State = analogRead(section3)*voltageScaler/1024.00;
  if (section3State >= pressThreshold)
    section3State = 1;
  else
    section3State = 0;
    
  section4State = analogRead(section4)*voltageScaler/1024.00;
  if (section4State >= pressThreshold)
    section4State = 1;
  else
    section4State = 0;
    
  section5State = analogRead(section5)*voltageScaler/1024.00;
  if (section5State >= pressThreshold)
    section5State = 1;
  else
    section5State = 0;
  
  section6State = analogRead(section6)*voltageScaler/1024.00;
  if (section6State >= pressThreshold)
    section6State = 1;
  else
    section6State = 0;

  section7State = analogRead(section7)*voltageScaler/1024.00;
  if (section7State >= pressThreshold)
    section7State = 1;
  else
    section7State = 0;
    
  section8State = analogRead(section8)*voltageScaler/1024.00;
  if (section8State >= pressThreshold)
    section8State = 1;
  else
    section8State = 0;
  
  section9State = analogRead(section9)*voltageScaler/1024.00;
